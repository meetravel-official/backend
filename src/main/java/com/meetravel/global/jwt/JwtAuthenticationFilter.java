package com.meetravel.global.jwt;
...
import com.meetravel.global.security.CustomAuthenticationEntryPoint;
import com.meetravel.global.security.SecurityConfig;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public boolean shouldNotFilter(HttpServletRequest request) {
        return Stream.of(
                ...
                new AntPathRequestMatcher("/ws/chat/info", HttpMethod.GET.name()),
                ...
                new AntPathRequestMatcher("/files", HttpMethod.POST.name())
